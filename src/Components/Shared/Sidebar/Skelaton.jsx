...
const Skelaton = () => {
    return (
        <aside className="fixed left-0 top-0 z-50 flex h-screen w-[285px] flex-col border-r border-white/10 bg-[#171717] transition-all duration-300 -translate-x-full lg:translate-x-0">
            {/* Header */}
